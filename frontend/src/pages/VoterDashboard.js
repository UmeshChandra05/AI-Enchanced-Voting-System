...
import { Vote, Landmark, LogOut, CheckCircle2 } from 'lucide-react';
      ...
      <div className="bg-[#1e3a8a] text-white py-6 px-6">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold" style={{ fontFamily: 'Merriweather, serif' }}>SmartBallot</h1>
              <p className="text-blue-200 text-sm">Voter Dashboard</p>
            </div>
          </div>
